...
const faqs = [
  {
    q: "Ar kaklo skausmas gali būti susijęs su darbu prie kompiuterio?",
    a: "Taip. Ilgalaikė sėdėsena, monotoniška padėtis, įtampa pečių juostoje ir sumažėjęs judėjimas dažnai prisideda prie simptomų atsiradimo ar pasikartojimo.",
  },
  {
    q: "Ar normalu, kad kaklo skausmas plinta į petį ar ranką?",
    a: "Taip gali būti. Tokie simptomai gali būti susiję su raumenų įtampa, judesio sutrikimu ar nervinių struktūrų dirginimu, todėl verta atlikti individualų įvertinimą.",
  },
  {
    q: "Ką daryti, jei kaklas sustingęs ir bijau judėti?",
    a: "Dažnai visiškas vengimas judėti nepadeda. Svarbiausia suprasti, kokie judesiai šiuo metu yra saugūs ir naudingi — tam reikalingas individualus specialisto įvertinimas.",
  },
  {
    q: "Kas geriau esant kaklo skausmui — kineziterapija ar manualinė terapija?",
    a: "Tai priklauso nuo situacijos. Vieniems labiau tinka aktyvesnis gydymas, kitiems pradžioje naudingesnis manualinis gydymas. Dažnai geriausias rezultatas pasiekiamas juos derinant.",
  },
  {
    q: "Kiek vizitų dažniausiai prireikia?",
    a: "Tai priklauso nuo simptomų trukmės, intensyvumo ir jūsų tikslų. Kartais pakanka kelių vizitų, kitais atvejais reikalingas nuoseklesnis gydymo planas.",
  },
  {
    q: "Ar gydymo metu gausiu rekomendacijų namoms?",
    a: "Taip. Jei reikia, gausite aiškias rekomendacijas dėl judesio, darbo padėties, pratimų ar kasdienės veiklos.",
  },
];
...
/* ── DATA ─────────────────────────────────────────────────────── */
const whenItems = [
  "Kaklo skausmas nepraeina ar kartojasi",
  "Sunku laisvai pasukti ar palenkti galvą",
  "Skausmas plinta į petį, ranką ar tarpumentį",
  "Dirbant prie kompiuterio simptomai stiprėja",
  "Jaučiate pečių juostos įtampą ar nuovargį",
  "Skausmas trukdo miegoti, vairuoti ar dirbti",
  "Po poilsio simptomai greitai grįžta",
  "Norite suprasti kaklo skausmo priežastį ir gydytis kryptingai",
];

const relatedItems = [
  "Raumenų įtampa ir perkrova kaklo bei pečių juostoje",
  "Sumažėjęs kaklo ar krūtinės dalies judrumas",
  "Ilgalaikė sėdėsena ar monotoniškas darbas",
  "Funkcinės laikysenos ir judesio kontrolės problemos",
  "Skausmas po fizinės perkrovos ar streso",
  "Dirginimas, dėl kurio simptomai plinta į petį ar ranką",
  "Galvos skausmai, susiję su kaklo ir pečių juostos įtampa",
  "Pasikartojantys simptomai dėl netolygaus krūvio ar sumažėjusio aktyvumo",
];

const assessSteps = [
  { n: "01", title: "Nusiskundimų aptarimas", text: "Aptariame, kada simptomai prasidėjo, kur tiksliai skauda, ar skausmas plinta, kas jį didina ir kas palengvina." },
  { n: "02", title: "Būklės ir judesio įvertinimas", text: "Vertiname kaklo, pečių juostos ir krūtinės dalies judrumą, laikyseną, judesio kokybę ir raumenų įtampą." },
  { n: "03", title: "Funkciniai testai", text: "Atliekame testus, padedančius geriau suprasti, ar simptomai susiję su raumenų perkrova, sąnarių judrumu ar nervų dirginimu." },
  { n: "04", title: "Problemos paaiškinimas", text: "Aiškiai paaiškiname, kas gali palaikyti simptomus ir kokia gydymo kryptis šiuo metu būtų tinkamiausia." },
  { n: "05", title: "Gydymo plano sudarymas", text: "Parenkame individualų planą — aktyvesnį, labiau manualinį arba mišrų, pagal jūsų būklę ir tikslą." },
];
...
const appliedItems = [
  ...
  "Kaklo ir pečių juostos judrumo gerinimas",
  "Laikysenos ir judesio korekcija",
  "Stabilumo ir kontrolės lavinimas",
  "Raumenų aktyvavimo pratimai",
  "Krūvio ir darbo pozicijos rekomendacijos",
  "Namų programos rekomendacijos",
];

const goalItems = [
  "Mažinti kaklo skausmą ir diskomfortą",
  "Mažinti pečių juostos įtampą",
  "Gerinti kaklo ir viršutinės nugaros dalies judrumą",
  "Atkurti judesio kokybę",
  "Mažinti simptomų plitimą į petį ar ranką",
  "Didinti pasitikėjimą judesiu",
  "Padėti grįžti prie darbo ir kasdienės veiklos be nuolatinio diskomforto",
];

const redFlags = [
  "Skausmas labai stiprus ir greitai progresuoja",
  "Atsiranda ryškus rankos silpnumas",
  "Ryškėja tirpimas ar jutimo pokyčiai rankoje",
  "Simptomai prasidėjo po rimtesnės traumos",
  "Stiprus galvos svaigimas ar ryškus bendros būklės pablogėjimas",
  "Karščiavimas ar kiti neįprasti bendrieji simptomai",
];

const services = [
  { title: "Kineziterapija", text: "Tinka, kai svarbiausia atkurti judesį, kontrolę, funkciją ir mažinti pasikartojančių simptomų riziką.", href: "/paslaugos/kineziterapija" },
  { title: "Manualinė terapija", text: "Tinka, kai reikia tikslingo manualinio gydymo kaklo ir aplinkinių sričių judrumo gerinimui.", href: "/paslaugos/manualine-terapija" },
  { title: "Osteopatija", text: "Tinka, kai svarbus platesnis kaklo, pečių juostos, krūtinės ląstos ir kitų kūno sričių ryšių vertinimas.", href: "/paslaugos/osteopatija" },
  { title: "Gydomasis masažas", text: "Gali būti naudingas, kai vyrauja ryški raumenų įtampa, sustingimas ar pečių juostos perkrova.", href: "/paslaugos/gydomasis-masazas" },
];

const specialists = [
  { name: "Piotr Dubrovskij", role: "Kineziterapeutas, osteopatas, manualinės terapijos specialistas", focus: "Kaklo skausmas, pečių juostos įtampa, judesio ribotumas ir kompleksinės kaklo–viršutinės nugaros dalies būklės", photo: "/specialist-piotr.jpg", slug: "piotr-dubrovskij" },
  { name: "Mangirdas Kazačenko", role: "Kineziterapeutas, manualinės terapijos specialistas", focus: "Kaklo skausmas, pečių juostos perkrova, pasikartojantys simptomai ir funkcijos atkūrimas", photo: "/specialist-mangirdas.jpg", slug: "mangirdas-kazacenko" },
  { name: "Erikas Jatkauskas", role: "Kineziterapeutas", focus: "Kaklo ir viršutinės nugaros dalies skausmas, funkcinė reabilitacija, grįžimas į aktyvumą", photo: "/specialist-erikas.jpg", slug: "erikas-jatkauskas" },
];
      ...
      <div style={{ background: "linear-gradient(160deg, #EEF5F4 0%, #F7FAF9 60%)" }}>
        <div className="container-xl pt-6 pb-12 md:pt-10 md:pb-16">
          ...
          <p className="text-[1rem] md:text-[1.125rem] text-secondary leading-relaxed mb-7 max-w-[560px]">
            Kaklo įtampa, skausmas, plintantys simptomai ar pečių juostos perkrova gali trukdyti darbui, poilsiui ir kasdienei savijautai. Įvertiname problemos pobūdį ir parenkame tinkamiausią gydymo kryptį.
          </p>
      ...
      <div className="container-xl py-10 md:py-14 flex flex-col gap-14 md:gap-16">
        ...
        <div id="kas-tai" className="grid md:grid-cols-2 gap-8 md:gap-12 items-start scroll-mt-32">
          <div>
            ...
            <SectionTitle>Kas yra kaklo skausmas?</SectionTitle>
            <div className="flex flex-col gap-3 text-[0.9375rem] text-secondary leading-relaxed">
              <p>Kaklo skausmas — dažna judėjimo sistemos problema, galinti pasireikšti ne tik lokaliu skausmu kaklo srityje, bet ir sustingimu, judesių ribotumu, įtampa pečių juostoje, galvos skausmu ar simptomų plitimu į petį, ranką ar tarpumenčio sritį.</p>
              <p>Simptomai gali atsirasti staiga arba vystytis palaipsniui. Jie dažnai susiję su ilgalaike sėdėsena, darbu prie kompiuterio, fizine perkrova, stresu, judesio stoka ar pasikartojančia pečių ir kaklo juostos įtampa.</p>
              <p>ReaMed klinikoje kaklo skausmą vertiname ne tik kaip vietinį simptomą. Mums svarbu suprasti, kaip juda kaklas, pečių juosta ir krūtinės ląstos dalis, kokie veiksniai palaiko simptomus ir kokia gydymo kryptis būtų naudingiausia jūsų atveju.</p>
            </div>
          </div>
          <div className="flex flex-col gap-3">
            {[
              { title: "Skausmas ne visada reiškia rimtą pažeidimą", text: "Dažnai simptomai susiję su perkrova, įtampa, sumažėjusiu judrumu ar funkciniu dirginimu." },
              { title: "Svarbus ne tik kaklas, bet ir aplinkinės sritys", text: "Pečių juosta, viršutinė nugaros dalis, laikysena ir judesio įpročiai dažnai turi didelę reikšmę simptomams." },
              { title: "Tikslas — ne tik sumažinti simptomus", text: "Siekiame padėti judėti laisviau, mažinti pasikartojimą ir gerinti bendrą funkciją." },
            ].map(({ title, text }) => (
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
          <div>
            ...
            <SectionTitle>Su kuo gali būti susijęs kaklo skausmas?</SectionTitle>
          ...
          <div className="rounded-2xl bg-[#EEF5F4] border border-[#D8E6E4] p-6 md:p-8">
            ...
            <p className="text-[0.9375rem] text-secondary leading-relaxed mb-4">
              Kaklo skausmo priežastys gali būti įvairios, todėl svarbiausia įvertinti ne tik skausmo vietą, bet ir tai, kaip juda visas kaklo–pečių juostos regionas.
            </p>
        ...
        <div id="kaip-vertiname" className="scroll-mt-32">
          ...
          <SectionTitle>Kaip vertiname kaklo skausmą?</SectionTitle>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-[0.875rem] text-secondary mb-4 leading-relaxed">
                Nors dauguma kaklo skausmo atvejų yra susiję su judėjimo sistema, kai kuriais atvejais svarbus greitesnis gydytojo įvertinimas. Nedelskite, jei:
              </p>
        ...
        <div id="paslaugos" className="scroll-mt-32">
          ...
          <SectionTitle>Kokios paslaugos gali tikti esant kaklo skausmui?</SectionTitle>
        ...
        <div>
          ...
          <SectionTitle>Kodėl pacientai kreipiasi į ReaMed dėl kaklo skausmo?</SectionTitle>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { title: "Vertiname ne tik kaklą", text: "Svarbu ne tik kur skauda, bet ir kaip juda pečių juosta, krūtinės dalis bei kokie įpročiai palaiko simptomus." },
              { title: "Aiškiai paaiškiname situaciją", text: "Po vizito suprasite, kas gali sukelti simptomus ir kokia gydymo kryptis jums šiuo metu tinkamiausia." },
              { title: "Gydymą parenkame pagal būklę", text: "Vieniems labiau tinka aktyvus gydymas, kitiems — manualinis ar mišrus požiūris." },
              { title: "Orientuojamės į funkciją", text: "Tikslas — ne tik sumažinti kaklo skausmą, bet ir padėti vėl laisviau judėti bei dirbti." },
        ...
        <div id="specialistai" className="scroll-mt-32">
          ...
          <SectionTitle>Specialistai, dirbantys su kaklo skausmu</SectionTitle>
        ...
        <div id="registruotis" className="rounded-2xl border border-[#DDE9E8] bg-white p-7 md:p-10 text-center">
          <h2 className="text-[1.5rem] md:text-[2rem] font-bold text-foreground mb-3">
            Norite suprasti, kas sukelia jūsų kaklo skausmą?
          </h2>
