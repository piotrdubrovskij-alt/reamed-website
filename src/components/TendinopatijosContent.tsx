...
const faqs = [
  {
    q: "Ar tendinopatija reiškia uždegimą?",
    a: "Ne visada. Daugeliu atvejų tai labiau susiję su audinio reakcija į apkrovą ir sumažėjusia tolerancija krūviui, o ne tik su klasikiniu uždegimu.",
  },
  {
    q: "Ar pakanka tiesiog pailsėti?",
    a: "Kartais trumpalaikis poilsis sumažina simptomus, tačiau jei nekeičiama apkrova ir neatkuriama funkcija, problema dažnai grįžta.",
  },
  {
    q: "Ar galima sportuoti, jei skauda tik po treniruotės?",
    a: "Tai priklauso nuo simptomų pobūdžio ir intensyvumo. Kartais aktyvumą galima tęsti koreguojant krūvį, tačiau svarbu suprasti, kokia apkrova šiuo metu yra tinkama.",
  },
  {
    q: "Kiek vizitų dažniausiai prireikia?",
    a: "Tai priklauso nuo problemos trukmės, apkrovos pobūdžio ir jūsų tikslo. Kartais pakanka kelių vizitų su aiškiu planu, kitais atvejais reikia nuoseklesnio proceso.",
  },
  {
    q: "Ar gydymo metu reikės pratimų?",
    a: "Dažniausiai taip. Tendinopatijų ir perkrovų atveju aktyvus, tinkamai dozuotas krūvis dažnai yra viena svarbiausių gydymo dalių.",
  },
  {
    q: "Ar gydymo metu gausiu rekomendacijų namams?",
    a: "Taip. Jei reikia, gausite aiškias rekomendacijas dėl pratimų, krūvio, poilsio ir grįžimo į aktyvumą.",
  },
];
...
/* ── DATA ─────────────────────────────────────────────────────── */
const whenItems = [
  "Skausmas kartojasi sportuojant ar po fizinio krūvio",
  "Problema nepraeina arba vis grįžta",
  "Skausmas juntamas toje pačioje vietoje tam tikrų judesių metu",
  "Po poilsio pagerėja, bet pradėjus aktyvumą simptomai vėl atsiranda",
  "Jaučiate jautrumą, tempimą ar sustingimą tam tikroje srityje",
  "Bėgimas, šuoliai ar jėgos pratimai pradeda provokuoti simptomus",
  "Norite suprasti, kaip koreguoti krūvį, o ne tik vengti judesio",
  "Svarbu grįžti į aktyvumą saugiai ir kryptingai",
];

const relatedItems = [
  "Sausgyslių perkrova ir dirginimas",
  "Pasikartojantis sportinis ar darbinis krūvis",
  "Per greitai padidintas fizinis aktyvumas",
  "Nepakankamas audinių pasirengimas krūviui",
  "Judesio kontrolės ir jėgos trūkumas",
  "Sumažėjęs apkrovos toleravimas po pertraukos ar traumos",
  "Raumenų ir sausgyslių disbalansas",
  "Nuolat pasikartojantis tų pačių judesių dirginimas",
];

const assessSteps = [
  { n: "01", title: "Nusiskundimų aptarimas", text: "Aptariame, kada simptomai prasidėjo, kokio krūvio metu jie atsiranda, kas juos stiprina ir kas laikinai palengvina." },
  { n: "02", title: "Būklės ir funkcijos įvertinimas", text: "Vertiname skausmo vietą, judrumą, jėgą, kontrolę, apkrovos toleranciją ir bendrą judesio modelį." },
  { n: "03", title: "Funkciniai testai", text: "Atliekame testus, padedančius geriau suprasti, kaip paveikta sritis reaguoja į krūvį ir kokie veiksniai palaiko simptomus." },
  { n: "04", title: "Problemos paaiškinimas", text: "Aiškiai paaiškiname, kas šiuo metu labiausiai tikėtina palaiko problemą ir kokia gydymo kryptis būtų logiškiausia." },
  { n: "05", title: "Gydymo plano sudarymas", text: "Parenkame individualų planą pagal simptomų stadiją, krūvio pobūdį ir jūsų tikslą." },
];

const appliedItems = [
  "Kineziterapija",
  "Sporto reabilitacija",
  "Manualinis gydymas pagal poreikį",
  "Individualiai parinkti jėgos pratimai",
  "Judesio technikos korekcija",
  "Krūvio valdymo rekomendacijos",
  "Stabilumo ir kontrolės lavinimas",
  "Palaipsnis apkrovos tolerancijos didinimas",
  "Namų programos rekomendacijos",
  "Grįžimo į aktyvumą planavimas",
];

const goalItems = [
  "Mažinti skausmą ir dirginimą",
  "Gerinti sausgyslių ir audinių toleranciją krūviui",
  "Atkurti jėgą, kontrolę ir funkciją",
  "Mažinti simptomų pasikartojimo riziką",
  "Padėti saugiau grįžti prie sporto, darbo ar aktyvumo",
  "Parinkti aiškią krūvio didinimo kryptį",
];

const redFlags = [
  "Skausmas atsirado staiga ir labai stipriai",
  "Negalite normaliai naudoti galūnės po įvykio",
  "Ryškus silpnumas ar staigus funkcijos praradimas",
  "Aiški trauma, kritimas ar plyšimo pojūtis",
  "Greitai didėja tinimas ar skausmas",
  "Neįprastai blogėja bendra būklė",
];

const services = [
  { title: "Kineziterapija", text: "Tinka, kai svarbiausia atkurti funkciją, judesį, jėgą ir mažinti simptomus palaikančius veiksnius.", href: "/paslaugos/kineziterapija" },
  { title: "Sporto reabilitacija", text: "Tinka, kai problema susijusi su sportu, grįžimu į treniruotes ar didesniu fiziniu krūviu.", href: "/paslaugos/sporto-reabilitacija" },
  { title: "Manualinė terapija", text: "Gali būti naudinga kaip pagalbinė gydymo plano dalis, siekiant mažinti diskomfortą ar gerinti judrumą.", href: "/paslaugos/manualine-terapija" },
  { title: "Gydomasis masažas", text: "Gali būti aktualus, kai kartu vyrauja raumenų įtampa ar aplinkinių audinių perkrova.", href: "/paslaugos/gydomasis-masazas" },
];

const specialists = [
  { name: "Piotr Dubrovskij", role: "Kineziterapeutas, osteopatas, manualinės terapijos specialistas", focus: "Pasikartojančios perkrovos, tendinopatijos, sportiniai simptomai ir funkcijos atkūrimas", photo: "/specialist-piotr.jpg", slug: "piotr-dubrovskij" },
  { name: "Kotryna Kairytė", role: "Kineziterapeutė", focus: "Sausgyslių perkrovos, pasikartojantis skausmas krūvio metu ir grįžimas į aktyvumą", photo: "/specialist-kotryna.jpg", slug: "kotryna-kairyte" },
  { name: "Erikas Jatkauskas", role: "Kineziterapeutas", focus: "Perkrovos po fizinio aktyvumo, apkrovos tolerancijos atkūrimas ir grįžimas į sportą", photo: "/specialist-erikas.jpg", slug: "erikas-jatkauskas" },
  { name: "Mangirdas Kazačenko", role: "Kineziterapeutas, manualinės terapijos specialistas", focus: "Tendinopatijos, pasikartojantis skausmas, audinių perkrova ir funkcinis atkūrimas", photo: "/specialist-mangirdas.jpg", slug: "mangirdas-kazacenko" },
];
    ...
    <div className="min-h-screen" style={{ background: "#F7FAF9", paddingTop: "104px" }}>
      ...
      <div style={{ background: "linear-gradient(160deg, #EEF5F4 0%, #F7FAF9 60%)" }}>
        <div className="container-xl pt-6 pb-12 md:pt-10 md:pb-16">
          ...
          <h1 className="text-[2rem] sm:text-[2.5rem] md:text-[3rem] font-bold text-foreground leading-[1.1] mb-4 max-w-[660px]">
            Tendinopatijos ir perkrovos Vilniuje
          </h1>
          <p className="text-[1rem] md:text-[1.125rem] text-secondary leading-relaxed mb-7 max-w-[580px]">
            Pasikartojantis skausmas fizinio krūvio metu ar po jo, jautrumas, sustingimas ir sumažėjusi apkrovos tolerancija gali būti susiję su sausgyslių perkrova ar kitais ilgiau besitęsiančiais judėjimo sistemos dirginimo procesais. Įvertiname simptomų pobūdį ir parenkame tinkamiausią gydymo kryptį.
          </p>
          <div className="flex flex-wrap gap-x-5 gap-y-2 mb-8">
            {["Įvertiname simptomų pobūdį ir apkrovos toleranciją", "Gydymą parenkame pagal būklę ir krūvio etapą", "Siekiame grąžinti funkciją ir toleranciją krūviui"].map((tp) => (
      ...
      <div className="container-xl py-10 md:py-14 flex flex-col gap-14 md:gap-16">
        ...
        <div id="kas-tai" className="grid md:grid-cols-2 gap-8 md:gap-12 items-start scroll-mt-32">
          <div>
            ...
            <SectionTitle>Kas yra tendinopatijos ir perkrovos?</SectionTitle>
            <div className="flex flex-col gap-3 text-[0.9375rem] text-secondary leading-relaxed">
              <p>Tendinopatijos ir perkrovos — tai būklės, kai dėl pasikartojančio, per didelio arba netinkamai toleruojamo krūvio atsiranda skausmas, jautrumas, sumažėjusi funkcija ir diskomfortas tam tikrose kūno vietose. Dažniausiai tokios problemos vystosi palaipsniui, o ne po vienos aiškios traumos.</p>
              <p>Simptomai dažnai pasireiškia sportuojant, po treniruočių, dirbant fiziškai aktyvų darbą ar atliekant pasikartojančius judesius. Iš pradžių skausmas gali būti juntamas tik po krūvio, vėliau — jo metu ar net kasdienėje veikloje.</p>
              <p>ReaMed klinikoje svarbu ne tik nustatyti, kad problema susijusi su sausgysle ar perkrova, bet ir suprasti, kaip jūsų kūnas toleruoja apkrovą ir kokia gydymo kryptis būtų tinkamiausia būtent dabar.</p>
            </div>
          </div>
          <div className="flex flex-col gap-3">
            {[
              { title: "Perkrova ne visada reiškia ūmią traumą", text: "Dažnai simptomai vystosi palaipsniui, kai audiniai nespėja prisitaikyti prie jiems tenkančio krūvio." },
              { title: "Poilsis ne visada išsprendžia problemą", text: "Kartais poilsis laikinai palengvina simptomus, tačiau problema grįžta, jei nekeičiama apkrova ir neatkuriama tolerancija krūviui." },
              { title: "Tikslas — ne tik sumažinti skausmą", text: "Siekiame padėti audiniams geriau toleruoti apkrovą ir saugiai grįžti prie aktyvumo." },
            ].map(({ title, text }) => (
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
          <div>
            ...
            <SectionTitle>Su kuo gali būti susijusios tendinopatijos ir perkrovos?</SectionTitle>
          ...
          <div className="rounded-2xl bg-[#EEF5F4] border border-[#D8E6E4] p-6 md:p-8">
            ...
            <p className="text-[0.9375rem] text-secondary leading-relaxed mb-4">
              Skausmas esant perkrovai ne visada reiškia, kad audinys yra stipriai pažeistas, tačiau tai rodo, kad dabartinis krūvis šiuo metu viršija audinių toleranciją.
            </p>
        ...
        <div id="kaip-vertiname" className="scroll-mt-32">
          ...
          <SectionTitle>Kaip vertiname tendinopatijas ir perkrovas?</SectionTitle>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-[0.875rem] text-secondary mb-4 leading-relaxed">
                Nors dauguma tendinopatijų ir perkrovų nėra skubios būklės, kai kuriais atvejais svarbu greičiau įvertinti situaciją. Nedelskite, jei:
              </p>
        ...
        <div id="paslaugos" className="scroll-mt-32">
          ...
          <SectionTitle>Kokios paslaugos gali tikti esant tendinopatijoms ir perkrovoms?</SectionTitle>
          ...
          <div className="mt-4 rounded-xl bg-[#EEF5F4] border border-[#D8E6E4] px-5 py-4">
            <p className="text-[0.875rem] text-muted leading-relaxed">
              <span className="font-semibold text-foreground">Svarbu:</span> tinkamiausia paslauga priklauso nuo simptomų pobūdžio, stadijos ir jūsų tikslo, todėl pirmiausia svarbus individualus įvertinimas.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <SectionTitle>Kodėl pacientai kreipiasi į ReaMed dėl tendinopatijų ir perkrovų?</SectionTitle>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { title: "Vertiname ne tik skausmo vietą", text: "Svarbu ne tik kur skauda, bet ir kaip kūnas toleruoja krūvį, kokie judesiai provokuoja simptomus ir ko trūksta funkcijai." },
              { title: "Aiškiai paaiškiname situaciją", text: "Po vizito suprasite, kodėl problema kartojasi ir kokia kryptis būtų naudingiausia." },
              { title: "Gydymą parenkame pagal etapą", text: "Vienais atvejais svarbiausia mažinti dirginimą, kitais — didinti apkrovą ir atkurti toleranciją." },
              { title: "Orientuojamės į grįžimą į krūvį", text: "Tikslas — ne tik sumažinti simptomus, bet ir padėti saugiai grįžti prie jums svarbaus aktyvumo." },
        ...
        <div id="specialistai" className="scroll-mt-32">
          ...
          <SectionTitle>Specialistai, dirbantys su tendinopatijomis ir perkrovomis</SectionTitle>
        ...
        <div id="registruotis" className="rounded-2xl border border-[#DDE9E8] bg-white p-7 md:p-10 text-center">
          <h2 className="text-[1.5rem] md:text-[2rem] font-bold text-foreground mb-3">
            Norite suprasti, kodėl skausmas kartojasi krūvio metu ar po jo?
          </h2>
